...
import com.bosnet.ngemart.libgen.barcode_scanner.camera.CameraInstance;
import com.bosnet.ngemart.libgen.barcode_scanner.camera.CameraSettings;
import com.bosnet.ngemart.libgen.barcode_scanner.camera.CameraSurface;
import com.bosnet.ngemart.libgen.barcode_scanner.camera.CenterCropStrategy;
import com.bosnet.ngemart.libgen.barcode_scanner.camera.DisplayConfiguration;
import com.bosnet.ngemart.libgen.barcode_scanner.camera.FitCenterStrategy;
import com.bosnet.ngemart.libgen.barcode_scanner.camera.FitXYStrategy;
import com.bosnet.ngemart.libgen.barcode_scanner.camera.PreviewScalingStrategy;
import com.bosnet.ngemart.ngemartlib.R;
...
public class CameraPreview extends ViewGroup {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                try {
                    if (motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                        cameraInstance.focusOnTouch(motionEvent);
                    }
                    return true;
                } catch (Exception e) {
                    Toast.makeText(getContext(), "Camera Preview : " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    return false;
                }
            }
        });
    ...
    public boolean isTorchOn() {
        if(cameraInstance != null) {
            return  cameraInstance.isTorchOn();
        }
        return false;
    }
    ...
    public void setAutoTorchOff() {
        if (cameraInstance != null) {
            cameraInstance.setAutoTorchOff();
        }
    }
