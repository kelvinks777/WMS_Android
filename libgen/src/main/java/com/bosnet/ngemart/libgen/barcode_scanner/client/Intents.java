...
public final class Intents {
    ...
    public static final class Scan {
         ...
         * the results.
         */
        public static final String ACTION = "com.bosnet.ngemart.libgen.barcode_scanner.client.SCAN";
        ...
        /**
         * Set to true to enable auto torch. Defaults to false.
         */
        public static final String AUTO_TORCH_ENABLED = "AUTO_TORCH_ENABLED";
