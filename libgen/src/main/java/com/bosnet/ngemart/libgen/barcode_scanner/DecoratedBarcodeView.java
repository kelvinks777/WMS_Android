...
import com.bosnet.ngemart.libgen.barcode_scanner.client.DecodeFormatManager;
import com.bosnet.ngemart.libgen.barcode_scanner.client.DecodeHintManager;
...
public class DecoratedBarcodeView extends FrameLayout {
    ...
    private void initialize(AttributeSet attrs) {
        ...
        if (barcodeView == null) {
            throw new IllegalArgumentException(
                "There is no a com.bosnet.ngemart.libgen.barcode_scanner.BarcodeView on provided layout " +
        ...
        if (viewFinder == null) {
            throw new IllegalArgumentException(
                "There is no a com.bosnet.ngemart.libgen.barcode_scanner.ViewfinderView on provided layout " +
    ...
    public void initializeFromIntent(Intent intent) {
        ...
        if (intent.hasExtra(Intents.Scan.AUTO_TORCH_ENABLED)) {
            boolean isAutoTorchEnabled = intent.getBooleanExtra(Intents.Scan.AUTO_TORCH_ENABLED, false);
            settings.setAutoTorchEnabled(isAutoTorchEnabled);
        }
