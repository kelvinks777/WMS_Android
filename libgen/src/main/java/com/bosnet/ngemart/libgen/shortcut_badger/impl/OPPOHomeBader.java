...
import com.bosnet.ngemart.libgen.shortcut_badger.util.CloseHelper;
 ...
 * refference : https://github.com/OneSignal/OneSignal-Android-SDK/blob/master/OneSignalSDK/onesignal/src/main/java/com/onesignal/shortcutbadger/impl/OPPOHomeBader.java
 */
...
public class OPPOHomeBader implements Badger {
    ...
    private int getSupportVersion() {
        int i = mCurrentTotalCount;
        if (i >= 0) {
            return mCurrentTotalCount;
        }
        try {
