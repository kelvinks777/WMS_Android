...
package com.bosnet.ngemart.libgen.barcode_scanner.integration;
...
import com.bosnet.ngemart.libgen.barcode_scanner.CaptureActivity;
import com.bosnet.ngemart.libgen.barcode_scanner.client.Intents;
...
public class IntentIntegrator {
    ...
    /**
     * Set to true to enable auto torch on scan.
     *
     * @param enabled true to enable auto torch
     * @return this
     */
    public IntentIntegrator setAutoTorchEnabled(boolean enabled) {
        addExtra(Intents.Scan.AUTO_TORCH_ENABLED, enabled);
        return this;
    }
     ...
     *
     * @param reqCode request code from {@code onActivityResult()}
     ...
     */
    public static IntentResult parseActivityResult(int reqCode, int resultCode, Intent intent) {
